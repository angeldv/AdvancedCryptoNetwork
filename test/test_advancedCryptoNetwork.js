// test/test_advancedCryptoNetwork.js
/**
 * Unit tests for AdvancedCryptoNetwork
 */

const assert = require('assert');
const { AdvancedCryptoNetwork } = require('../src/main');
const fs = require('fs').promises;
const path = require('path');

describe('AdvancedCryptoNetwork', function() {
    this.timeout(5000);
