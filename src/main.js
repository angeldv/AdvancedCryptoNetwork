// src/main.js
/**
 * Main entry point for AdvancedCryptoNetwork application
 */
...
class AdvancedCryptoNetwork {
    /**
     * Create a new AdvancedCryptoNetwork instance
...
module.exports = AdvancedCryptoNetwork;
...
if (require.main === module) {
    ...
    const app = new AdvancedCryptoNetwork({
        input: args.input,
        output: args.output,
